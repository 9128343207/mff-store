        ...
        $('.slider-range-price').each(function(){
                ...
                $( this ).slider({
                    ...
                    slide: function( event, ui ) {
                        var result = label_reasult +" <span>"+ unit + ui.values[ 0 ] +' </span><input type="hidden" name="pfrom" value="'+ui.values[ 0 ]+'"> - <span> '+ unit +ui.values[ 1 ]+'</span><input type="hidden" name="pto" value="'+ui.values[ 1 ]+'">';
