            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="product-status-wrap">
                    ...
                    <div class="asset-inner">
                        ...
                        <tr><td><b>Order Status</b></td><td>{{ $ordersSummary->orderDetail->ad_status}}/{{ $ordersSummary->orderDetail->vn_status}}</td><td>
                            @if($ordersSummary->orderDetail->ad_status == 'COMPLETED')
                               <a href="#">PAY TO STORE</a> 
                            @endif
                        </td></tr>
                        ...
                        <select id="paystatus" name="paystatus">
                                ...
                                <option value="NOTIFYTOSTORE">Proceed order to Store for shipment</option>
                                <!-- <option value="SHIPPING">Shiping</option> -->
                                <!-- <option value="PAYTOSTORE">Pay to store</option> -->
...
@section('script')
    ...
    <script> 
        function NewTab() { 
            window.open( 
              "/invoice/s/{{ $ordersSummary->orderDetail->id}}", "_blank"); 
        } 
    </script> 
@endsection
