                    ...
                    <div class="add-product">
                        <form>
                            <select id="paystatus" name="paystatus">
                                ...
                                <option value="NOTIFYTOSTORE">Notify to store</option>
                        ...
                        <table>
                            ...
                            @if(count($orders) != 0)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <!-- <button type="button" onclick="orderDetail(this)" class="btn btn-primary" data-id='{{$order->id}}' data-toggle="modal" >
                                    View
                                    </button> -->
                                    <a href="/admin/orders/get-order-details/{{$order->id}}">View</a>
                                    <td>
                                </tr>
                                @endforeach
                                @else 
